package com.vcp.hessen.kurhessen.views.meineveranstaltungen;
...
@Route(value = "events/:sampleAddressID?/:action?(edit)", layout = MainLayout.class)
@RolesAllowed("USER")
public class MeineVeranstaltungenView extends Div implements BeforeEnterObserver {
    ...
    public MeineVeranstaltungenView(SampleAddressService sampleAddressService) {
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(MeineVeranstaltungenView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (sampleAddressId.isPresent()) {
            ...
            if (sampleAddressFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(MeineVeranstaltungenView.class);
            }
        }
    }
